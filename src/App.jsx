...
function App() {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-[#fdf6ec] p-4 md:p-8">
      <div className="mx-auto flex w-full max-w-4xl flex-col overflow-hidden rounded-[32px] bg-white shadow-xl transition-shadow duration-300 hover:shadow-2xl md:flex-row">
        <div className="relative flex flex-col justify-between overflow-hidden bg-[#3d1f3d] p-8 text-white md:w-2/5 md:p-10">
          ...
          <div className="relative mt-10 flex items-center gap-2 rounded-2xl bg-white/10 px-4 py-3 text-xs font-semibold text-white/80 transition-colors">
            ...
            />
            <span>
              {items.length} guitar{items.length !== 1 ? "s" : ""} registered so
              far
            </span>
          </div>
        </div>
